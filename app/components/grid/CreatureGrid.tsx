 ...
 * Manages shared WebGL renderer for card thumbnails.
 */
export function CreatureGrid() {
  ...
  const handleCardHover = (event: React.MouseEvent, result: CreatureSimulationResult, rank: number) => {
    const rect = (event.currentTarget as HTMLElement).getBoundingClientRect();
    showTooltip(result, rect, rank);
  };
