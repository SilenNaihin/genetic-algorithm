...
export const TOOLTIPS = {
  ...
  neatAddConnectionRate: 'Probability of adding a new connection between neurons per generation. NEAT standard is 50% - high rates are safe because speciation protects innovations. Lower rates (5-20%) for slower, more conservative evolution. Default 50%.',
  neatAddNodeRate: 'Probability of adding a new hidden neuron per generation. NEAT standard is 20%. New neurons split existing connections and increase network depth. Lower rates (3-10%) for simpler networks. Default 20%.',
