...
def single_point_crossover(
    ...
    for i in range(len(muscles1)):
        ...
        child_muscles.append({
            ...
            'damping': lerp(muscle1.get('damping', 3.0), muscle2.get('damping', 3.0), t),
...
def uniform_crossover(
    ...
    for i in range(len(muscles_s)):
        ...
        child_muscles.append({
            ...
            'damping': muscle_s.get('damping', 3.0) if random.random() < 0.5 else muscle_o.get('damping', 3.0),
...
def clone_genome(
    ...
    for muscle in muscles:
        ...
        new_muscles.append({
            ...
            'damping': muscle.get('damping', 3.0),
